"""Пути и константы домена (ЛР 4) + настройки Kafka-пайплайна."""
...
TOPIC_PRICES_TRANSFORMED = "prices.transformed"
TOPIC_PRICES_FILTERED = "prices.filtered"

# Служебное сообщение конца батча (после строк CSV)
CONTROL_END = {"_control": "end"}
