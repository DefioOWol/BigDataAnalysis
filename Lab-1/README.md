...
### Почему не связано с темой диссертации

Причина проста: в выбранной теме (разработка программных элементов для интеграции VR и ИИ
для управления реальными объектами) на данный момент сложно представить источники больших данных.
